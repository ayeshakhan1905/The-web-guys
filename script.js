...
initializeImage(img1);
initializeImage(img2);
initializeImage(img3);
initializeImage(img4);
initializeImage(img5);
initializeImage(img6);

elm1.addEventListener('mousemove', function(dets){
    img1.style.left = dets.clientX - 250 + 'px';
    img1.style.top = dets.clientY - 200 + 'px';
    gsap.to('.elem1 .img1', {
        opacity: 1,
        duration: 0.5
    });
...
elm2.addEventListener('mousemove', function(dets){
    img2.style.left = dets.clientX - 250 + 'px';
    img2.style.top = dets.clientY - 200 + 'px';
    gsap.to('.elem2 .img2', {
        opacity: 1,
        duration: 0.5
    });
...
elm3.addEventListener('mousemove', function(dets){
    img3.style.left = dets.clientX - 250 + 'px';
    img3.style.top = dets.clientY - 200 + 'px';
    gsap.to('.elem3 .img3', {
        opacity: 1,
        duration: 0.5
    });
...
elm4.addEventListener('mousemove', function(dets){
    img4.style.left = dets.clientX - 250 + 'px';
    img4.style.top = dets.clientY - 200 + 'px';
    gsap.to('.elem4 .img4', {
        opacity: 1,
        duration: 0.5
    });
...
elm5.addEventListener('mousemove', function(dets){
    img5.style.left = dets.clientX - 250 + 'px';
    img5.style.top = dets.clientY - 200 + 'px';
    gsap.to('.elem5 .img5', {
        opacity: 1,
        duration: 0.5
    });
...
elm6.addEventListener('mousemove', function(dets){
    img6.style.left = dets.clientX - 250 + 'px';
    img6.style.top = dets.clientY - 200 + 'px';
    gsap.to('.elem6 .img6', {
        opacity: 1,
        duration: 0.5
    });
